...
public class SoftwareController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SoftwareDTO> updateSoftware(@PathVariable Long id, @RequestBody SoftwareDTO softwareDTO) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SoftwareDTO> getSotfwareById(@PathVariable Long id) {
